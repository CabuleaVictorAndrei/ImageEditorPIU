...
from undoRedoManager import UndoRedoManger
...
class UX(QMainWindow):
    def __init__(self):
        ...
        # class members
        self.canvas = Canvas()
        self.undoRedoManager = UndoRedoManger()
    ...
    def brightnessSliderValueChanged(self):
        try:
            ...
            image = changeBrightness(self.noBrightnessModificationImage, int(self.brightnessSlider.value()))
